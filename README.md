...
`Scripts/bootstrap-tvvlckit.sh` to build the pinned compatibility-player with
MLP/TrueHD decoding enabled and install it under the ignored `Carthage/Build`
