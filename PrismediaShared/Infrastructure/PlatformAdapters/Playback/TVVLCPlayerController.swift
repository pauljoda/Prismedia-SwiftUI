    ...
    struct TVVLCPlayerController: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: Context) -> UIViewController {
            ...
            context.coordinator.install(request, in: viewController.view)
        ...
        func updateUIViewController(
            ...
            context.coordinator.update(request, in: viewController.view)
        }
        ...
        final class Coordinator: NSObject, VLCMediaPlayerDelegate {
            ...
            func install(_ request: VideoCompatibilityPlaybackRequest, in view: UIView) {
                tearDownPlayer()
            ...
            func update(_ request: VideoCompatibilityPlaybackRequest, in view: UIView) {
                guard self.request != request else { return }
                install(request, in: view)
            }
            ...
            func mediaPlayerStateChanged(_ notification: Notification) {
                ...
                case .error:
                    controller?.compatibilityPlaybackDidFail("The compatibility player could not decode this video.")
                case .stopped:
                    publishState(isPlaying: false, isWaiting: false)
                @unknown default:
                    publishState(isPlaying: false, isWaiting: false)
