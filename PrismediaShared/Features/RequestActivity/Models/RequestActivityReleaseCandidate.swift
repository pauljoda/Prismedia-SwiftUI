...
public struct RequestActivityReleaseCandidate: Decodable, Equatable, Identifiable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        sizeBytes = try PrismediaDecoding.integer64(from: container, forKey: .sizeBytes)
        seeders = try PrismediaDecoding.optionalInteger(from: container, forKey: .seeders)
        ...
        score = try PrismediaDecoding.double(from: container, forKey: .score)
