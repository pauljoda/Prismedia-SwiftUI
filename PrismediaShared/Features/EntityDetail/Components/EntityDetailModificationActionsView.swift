...
struct EntityDetailModificationActionsView: View {
    ...
    private var supportedActions: [EntityDetailAction] {
        presentation.modificationActions.filter {
...
#if DEBUG
    #Preview("Entity Detail Modification Actions") {
