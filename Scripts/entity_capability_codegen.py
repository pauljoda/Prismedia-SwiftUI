...
CAPABILITY_PAYLOAD_TYPES = {
    ...
    "comic-installment-metadata": "EntityComicInstallmentMetadataCapability",
    ...
    "ordered-sequence": "EntityOrderedSequenceCapability",
    "page-sequence": "EntityPageSequenceCapability",
    "person-profile": "EntityPersonProfileCapability",
    "playable-audio": "EntityPlayableAudioCapability",
